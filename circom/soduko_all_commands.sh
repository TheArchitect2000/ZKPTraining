...
# The tau power ceremony is designed to accommodate up to 2^16 constraints.
...
snarkjs powersoftau new bn128 16 phase1_pot12_00.ptau -v 
...
# The 'circuit_proof_groth16.json' file encapsulates the actual proof, while 'output.json' details the values of public outputs.
